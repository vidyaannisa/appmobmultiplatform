 ...
 return db.executeSql(sql, params).then((data: any) =>
{
 ...
 .catch(e => console.error('Category gagal diambil: ',
e));
 })
 ...
 return db.executeSql(sql, []).then((data: any) => {
  ...
  }).catch(e => console.error('Kategori gagal diload: ',
 e));
  }).catch((e) => console.error(e));
  }
 ...
 SQLiteObject) => {
  ...
  .catch(e => console.error('Category gagal diubah: ',
 e));
  })
  .catch((e) => console.error(e));
  }
 ...
 SQLiteObject) => {
  ...
  .catch(e => console.error('Category gagal dihapus: ',
e));
 })
 .catch((e) => console.error(e));
 }
